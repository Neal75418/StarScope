...
export const translations = {
  en: {
    ...
    dashboard: {
      ...
      signals: {
        ...
        copy: {
          ...
          breakout: "Breakout: velocity went from {prev} to {current} stars/day",
    ...
    watchlist: {
      ...
      summary: {
        title: "Summary",
        topVelocity: "Top Velocity (/day)",
        hotRepos: "Hot Repos",
        signalRepos: "With Signals",
        staleRepos: "Stale data",
      },
      batch: {
        select: "Select",
        cancel: "Cancel",
    ...
    compare: {
      ...
      starMetricsOnly: "Star metrics (absolute)",
      metrics: "Metrics",
      ...
      columns: {
        ...
        velocity: "Velocity",
        acceleration: "Accel",
        accelerationHint: "Change in daily growth rate vs last week",
        trend: "Trend",
      },
      perDay: "/day",
      diff: {
    ...
    settings: {
      ...
      import: {
        ...
        statusSuccess: "Import successful",
        statusError: "Import failed",
        statusSkipped: "Skipped (already tracked)",
      ...
      diagnostics: {
        ...
        lastSync: "Last Snapshot",
        dbPath: "Database Path",
        lastFetchSuccess: "Last Successful Fetch",
      ...
      interests: {
        ...
        weightHint: "How strongly a match on this term pushes a repo into your 20 daily picks",
        weight1: "1 · Minor",
        weight2: "2 · Normal",
        weight3: "3 · Strong",
        add: "Add",
        ...
        trending: {
          ...
          refreshingShort: "Checking…",
          phaseSampling: "Sampling new projects",
          phaseCounting: "Measuring how common each topic is",
  ...
  "zh-TW": {
    ...
    trends: {
      ...
      columns: {
        ...
        delta30d: "30 天 Δ",
        acceleration: "加速度",
        forksDelta7d: "Fork 7 天 Δ",
        issuesDelta7d: "Issue 7 天 Δ",
      },
      filters: {
        allLanguages: "所有語言",
        minStars: "最低星數",
    ...
    compare: {
      ...
      columns: {
        ...
        velocity: "速度",
        acceleration: "加速度",
        accelerationHint: "每日成長率與上週相比的變化",
        trend: "趨勢",
      },
      perDay: "/天",
      diff: {
    ...
    settings: {
      ...
      alerts: {
        ...
        conditions: {
          stars_delta_7d: "7 天星星變化",
          stars_delta_30d: "30 天星星變化",
          velocity: "成長速度",
          acceleration: "加速度",
          trend: "趨勢",
        },
      ...
      interests: {
        ...
        kindKeyword: "關鍵字",
        weightLabel: "優先度",
        weightHint: "命中這個詞的專案，要多用力擠進每天 20 條推薦",
        weight1: "1 · 次要",
        weight2: "2 · 一般",
        weight3: "3 · 強烈",
        add: "新增",

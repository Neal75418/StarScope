...
export const translations = {
  en: {
    ...
    watchlist: {
      ...
      connection: {
        ...
        message: "Cannot connect to StarScope engine. Make sure Python sidecar is running.",
        hint: "Start the Python sidecar with:",
        retry: "Retry",
      },
    },
    // Repo card
  ...
  "zh-TW": {
    ...
    watchlist: {
      ...
      connection: {
        title: "連線錯誤",
        message: "無法連接到 StarScope 引擎。請確認 Python sidecar 正在執行。",
        hint: "使用以下指令啟動 Python sidecar：",
        retry: "重試",
      },
    },
    // Repo card

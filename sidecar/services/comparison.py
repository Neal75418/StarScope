...
from db.models import ComparisonGroup, ComparisonMember, RepoSnapshot, HealthScore, Signal, SignalType

logger = logging.getLogger(__name__)


def _build_member_data(member: "ComparisonMember", db: Session) -> Dict[str, Any]:
    """Build data dict for a single comparison member."""
    repo = member.repo
...
def _calculate_summary_stats(member_data: list) -> Dict[str, Any]:
    """Calculate summary statistics from member data."""
...
class ComparisonService:
    ...
    @staticmethod
    def get_comparison_summary(group_id: int, db: Session) -> Optional[Dict[str, Any]]:
        """
        ...
        member_data = [_build_member_data(member, db) for member in members]
        summary = _calculate_summary_stats(member_data)
    ...
    @staticmethod
    def get_velocity_comparison(group_id: int, db: Session) -> Optional[Dict[str, Any]]:
        """
